<%-- 
    Document   : Home
    Created on : Aug 16, 2024, 9:01:06 AM
    Author     : ADMIN
--%>
                    ...
                    <div class="container-fluid">
                        ...
                        <div
                            ...
                            <form class="navbar-form navbar-right">
                                <button type="submit" class="btn btn-default" value="0" name="form">Đăng nhập</button>
                                <button type="submit" class="btn btn-default" value="1" name="form">Đăng ký</button>
                            </form>
                            <%
                                if (request.getParameter("form") != null) {
                                    int option = Integer.parseInt(request.getParameter("form"));
                                    if (option == 0) {
                            %>
                            ...
                            %>
                            <jsp:forward page="CreateNewAccount.jsp"/> 
                            <%
                                    }
                                }
                            %>
