...
<!--                                        <a href="delete?pid=${o.id}"><button type="button" class="btn btn-danger"><i class="material-icons" data-toggle="tooltip" title="Delete">&#xE872;</i></button></a>-->
                ...
                <div class="clearfix">
                    ...
                    <ul class="pagination">
                        <li class="page-item"><a href="manageraccount?page=${page-1==0?(1):(page-1)}" class="page-link">Trước đó</a></li>
                            <c:forEach begin="${1}" end="${requestScope.num}" var="i">                                                     
                            <li class="page-item"><a href="manageraccount?page=${i}" class="page-link">${i}</a></li>                          
                            </c:forEach>
                        <li class="page-item"><a href="manageraccount?page=${page+1>num?(num):(page+1)}" class="page-link">Tiếp theo</a></li>
