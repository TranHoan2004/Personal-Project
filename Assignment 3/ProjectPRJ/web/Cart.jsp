...
<html>
    ...
    <body onload="loadTotalMoney()">
                ...
                <div class="px-4 px-lg-0">
                    ...
                    <div class="pb-5">
                        ...
                        <div class="row py-5 p-4 bg-white rounded shadow-sm">
                            ...
                            <div class="col-lg-6">
                                <div class="bg-light rounded-pill px-4 py-3 text-uppercase font-weight-bold">Chuẩn bị hóa đơn</div>

                                <div class="p-4">
                                    <ul class="list-unstyled mb-4" id="contentTotalMoney">

                                    </ul><a href="order" class="btn btn-dark rounded-pill py-2 btn-block text-white">Sãn sàng để chi trả</a>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        window.addEventListener("load", function loadAmountCart() {
            $.ajax({
                url: "/ProjectPRJ/loadAllAmountCart",
                type: "get", //send it through get method
                data: {
                },
                success: function (responseData) {
