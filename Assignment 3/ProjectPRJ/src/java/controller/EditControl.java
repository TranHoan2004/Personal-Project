...
public class EditControl extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (!pcategory2.equals("") && cdao.categoryExist(pcategory2.toUpperCase()) == null) {
            cdao.insertCategory(listC.size() + 1, pcategory2.toUpperCase());
            pcategory = Integer.toString(listC.size() + 1);
        }
        pdao.editProduct(pname, pimage, pprice, ptitle, pdescription, pcategory, pmodel, pcolor, pdelivery, pimage2, pimage3, pimage4, pid);
